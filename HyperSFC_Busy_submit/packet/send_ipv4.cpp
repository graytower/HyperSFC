...
int main()
{
    ...
    unsigned char send_ip_src_addr[4] = {0x0a, 0x00, 0x01, 0x01};
    unsigned char send_ip_dst_addr[4] = {0x0a, 0x00, 0x03, 0x03};
    ...
    {   
        ...
        // Set: H_TCP
        unsigned char send_tcp_src_port[2] = {0x00, 0x1c};
        unsigned char send_tcp_dst_port[2] = {0x00, 0xac};
